#ifndef _E_BEAM_BUMPY_POLY_H_
#define _E_BEAM_BUMPY_POLY_H_

/*****************************************************************************
 * e_beam_bumpy_poly.h:                                                      *
 *    class declarations and inline member functions for:                    *
 *       e_beam_bumpy_poly: triple electron source model, poly-energetic     *
 ...
 *                                                                           *
 * revisions:                                                                *
 *    coded by modifying e_beam_triple_poly.h             MF 27.02.2005      *
 *                                                                           *
 *****************************************************************************/
...
// triple electron source model, poly-energetic with bump correction
...
class e_beam_bumpy_poly : public e_beam_bumpy_mono
{
   public:
      e_beam_bumpy_poly(const beam_core *this_beam)
         : e_beam_bumpy_mono(this_beam)
      {
         init_energy();
         init_photons();
      }
...
inline real e_beam_bumpy_poly::sample_energy(ranmar &rndm)
{
   // energy
   real energy = ZERO;
