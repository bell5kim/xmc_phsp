...
// ***********************************************
// member functions of class e_beam_triple_mono
// ***********************************************

// base data file input
void e_beam_triple_mono::get_base_data()
{
...
// get particle parameters from triple electron source
bool e_beam_triple_mono::emit(particle_parameters &p,
#ifdef USE_SOBOL
...
void e_beam_triple_mono::emit(particle_type &type,    real   &energy,
...
// from triple electron source
bool e_beam_triple_mono::emit(real   &weight,
