...
// ****************************************
// member functions of class MC_mlc_rfocus
// ****************************************

// initialize MLC
void MC_mlc_rfocus::init(void)
{
   // check and set parameters for the leaf end curvature
   if (nominal_mlc->get_z_center_curve() == NULL)
   {
      xvmc_error("MC_mlc_rfocus::init",
   ...
   // six further points for the left and right leaf ends
...
void MC_mlc_rfocus::change_pair(const int  &pair_index,
