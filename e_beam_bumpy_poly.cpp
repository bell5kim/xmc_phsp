 ...
 *                                                                           *
 * revisions:                                                                *
 *    coded by modifying e_beam_triple_poly.cpp           MF 27.02.2005      *
 *                                                                           *
 *****************************************************************************/
...
// ***********************************************
// member functions of class e_beam_bumpy_poly
// ***********************************************

// initialize energy spectrum
void e_beam_bumpy_poly::init_energy(void)
{
...
void e_beam_bumpy_poly::init_photons(void)
{
...
bool e_beam_bumpy_poly::add_photons(real &cpu_time, int n_batch)
{
   // measure CPU time
